...
This folder contains the implementation of the AFIIN model for pan-sharpening. 

For more details, please refer to 

[Adaptively Learning Low-high Frequency Information Integration for Pan-sharpening](https://dl.acm.org/doi/abs/10.1145/3503161.3547924)

**Please note that the training datasets are not currently public. You are encouraged to train and test on your own satellite datasets.**

The Network arch is located in model/AFIIN.py
